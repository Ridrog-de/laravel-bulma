...
class BulmaPreset
{
    ...
    {
        copy(realpath(__DIR__.'/../stubs/Assets/sass/_variables.scss'), resource_path('assets/sass/_variables.scss'));
        copy(realpath(__DIR__.'/../stubs/Assets/sass/app.scss'), resource_path('assets/sass/app.scss'));
    }
